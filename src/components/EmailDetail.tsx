...
export const EmailDetail: React.FC<EmailDetailProps> = ({
  ...
  return (
    ...
    >
      {/* Email Header */}
      <motion.div 
        className="border-b border-cream/10 px-8 py-6 backdrop-blur-sm"
        initial={{ y: -20, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {/* Action Buttons */}
        <motion.div 
          className="border-t border-cream/10 px-8 py-6 backdrop-blur-sm"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="flex gap-4">
            ...
            <motion.button 
              className="flex items-center gap-2 px-6 py-3 secondary-button rounded-xl font-light"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              <ReplyAll size={16} />
